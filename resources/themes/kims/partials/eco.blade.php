<div class="eco-popup main-popup">
    <div class="main-popup__wrapper">
        ...
        <div class="main-popup__title"><span>{!! config('app.name') !!}</span><br>ЭКО ПРОЕКТ</div>
        ...
        <div class="eco-popup__wrapper">
			...
			<div class="eco-popup__right">
				<div class="eco-popup__subTitle">
					@lang('front_texts.eco_title')
                </div>
                <div class="main-popup__desk">
					<strong>@lang('front_texts.eco_text-1')</strong>
					<br><br>
					@lang('front_texts.eco_text-2')
					<br><br>
					@lang('front_texts.eco_text-4')
                </div>
			</div>
        </div>
		...
		<div class="main-popup__desk"><br><strong>@lang('front_texts.eco_text-5')</strong></div>
