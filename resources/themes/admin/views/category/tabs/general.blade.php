...
<div class="form-group @if ($errors->has('level')) has-error @endif">
    {!! Form::label('level', trans('labels.level'), ['class' => 'control-label col-xs-4 col-sm-3 col-md-2']) !!}

    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
        {!! Form::select('level', $levels, $model->level ?: 0, ['class' => 'form-control input-sm select2']) !!}

        {!! $errors->first('level', '<p class="help-block error">:message</p>') !!}
    </div>
</div>
...
<div class="form-group @if ($errors->has('parent_id')) has-error @endif">
    {!! Form::label('parent_id', trans('labels.parent_category'), ['class' => 'control-label col-xs-4 col-sm-3 col-md-2']) !!}

    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
        {!! Form::select('parent_id', $parents, null, ['class' => 'form-control select2 input-sm', 'aria-hidden' => 'true']) !!}
