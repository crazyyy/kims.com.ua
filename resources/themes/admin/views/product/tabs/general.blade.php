<div class="form-group @if ($errors->has('category_id')) has-error @endif">
    {!! Form::label('category_id', trans('labels.parent_category'), ['class' => 'control-label col-xs-4 col-sm-3 col-md-2']) !!}

    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
        {!! Form::select('category_id', $categories, null, ['class' => 'form-control select2 input-sm', 'aria-hidden' => 'true']) !!}
