...
function googleMapInit() {
    var _latitude = 49.1898929;
    var _longitude = 31.5750698;
    ...
    var location_default = new google.maps.LatLng(_latitude, _longitude);
...
function setDepartmentContacts(department) {
    var keys = ['name', 'address', 'description', 'phone', 'email'];
    ...
    var $active_city = $('.contacts__cities-item.active');
    ...
    var $city = $('.contacts__cities-item[data-id="' + department['id'] + '"]');
    $city.fadeOut();
    setTimeout(function () {
...
function footerCitiesSwitcherInit() {
    var $cities = $('.contacts__cities-item');
...
$(function () {
    ...
    $('.h-nav').on('click', function () {
        var $navList = $(this).find('.h-nav__list');
    ...
    (function depNavigation() {
        ...
        $franch = $('.header__franchise'), $title.on('click', function () {
            // $list.slideToggle('fast');
            var $citySwitch = $('.city-switch.main-popup');
    ...
    $('.h-lang').on('click', function () {
        var $navList = $(this).find('.h-lang__list');
    ...
    function priceSection() {
        ...
        function init() {
            var $current = $leftList.find('.s-left__item').eq(currMain),
    ...
    (function contactPopup() {
        var $contactPopup = $('.contact-popup.main-popup'),
    ...
    (function advPopup() {
        var $advPopup = $('.adv-popup.main-popup'),
    ...
    (function citySwitch() {
        ...
        $list.on('click', 'div.city-switch__item', function () {
            ...
            var odessa_link = 'http://www.himstat.ru/LK.php?CompanyID=31&UseLogin=1',
    ...
    $('#js-fullpage').fullpage({
        ...
        afterLoad: function afterLoad(index, anchorLink) {
            var $header = $('.header'),
