<header class="header">
    <a href="#main" class="header__logo"></a>
        <?php if(isset($current_department['id']) && $current_department['id'] == 2): ?>
        <a href="http://www.himstat.ru/LK.php?CompanyID=31&UseLogin=1" target="_blank" class="header__cabinet h-cab" data-active="true"><?php echo trans('front_labels.dashboard'); ?></a>
            <?php elseif(isset($current_department['id']) && $current_department['id'] == 7): ?>
        <a href="http://www.himstat.ru/LK.php?CompanyID=47&UseLogin=1" target="_blank" class="header__cabinet h-cab" data-active="true"><?php echo trans('front_labels.dashboard'); ?></a>
            <?php else: ?>
    <a href="#" class="header__cabinet h-cab"  data-active="false" target="_blank"><?php echo trans('front_labels.dashboard'); ?></a>
    <?php endif; ?>
    ...
    <nav class="header__nav h-nav">
        ...
        <ul id="js-nav" class="h-nav__list">
            ...
            <li data-menuanchor="services" class="h-nav__item"><a href="#services"><?php echo app('translator')->get('front_labels.services'); ?></a>
            </li>
            <li data-menuanchor="contacts" class="h-nav__item"><a href="#contacts"><?php echo app('translator')->get('front_labels.contacts'); ?></a>
            </li>
        </ul>
    </nav>

    <div class="header__languages h-lang">
    ...
    <div class="header__contacts h-contacts">
        ...
        <div class="h-contacts__departments h-dep">
        ...
        <a href="#contacts" class="h-contacts__link"><?php echo app('translator')->get('front_labels.contacts'); ?></a>
        <a target="_blank" href="<?php echo variable('facebook_link'); ?>" class="h-contacts__fb">
            <?php echo app('translator')->get('front_labels.facebook'); ?>
        </a>
        <?php if(isset($current_department['id']) && $current_department['id'] == 2): ?>
            <a href="http://www.himstat.ru/LK.php?CompanyID=31&UseLogin=1" target="_blank" class="h-contacts__cabinet h-cab" data-active="true">Личный кабинет</a>
        <?php elseif(isset($current_department['id']) && $current_department['id'] == 7): ?>
            <a href="http://www.himstat.ru/LK.php?CompanyID=47&UseLogin=1" target="_blank" class="h-contacts__cabinet h-cab" data-active="true">Личный кабинет</a>
        <?php else: ?>
        <a href="#" target="_blank" class="h-contacts__cabinet h-cab" data-active="false">Личный кабинет</a>
            <?php endif; ?>
    </div>
</header>